...
<svelte:head>
  ...
  <!-- Facebook Meta Tags -->
  <meta property="og:url" content={`https://description-editor.vercel.app/descriptionEditor/${hash}`} />
  ...
  <meta property="twitter:url" content={`https://description-editor.vercel.app/descriptionEditor/${hash}`} />
