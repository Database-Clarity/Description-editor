...
export function checkLanguages(URLparams: URLSearchParams, required: boolean = false) {
...
export function checkTimestamps(URLparams: URLSearchParams) {
  // check if language parameter if present
...
export function checkHashes(URLparams: URLSearchParams, requestHeader: Headers) {
